...
const CreateInvoice = ({
  ...
  return (
    <div
      ...
      className="  fixed top-0 bottom-0 left-0 lg:left-20 right-0  bg-[#03142E]"
    >
      <motion.div
        ...
        className="  scrollbar-hide flex flex-col dark:text-white dark:bg-[#0c1e39] bg-white  md:pl-[150px] py-16 px-6 h-screen md:w-[768px] md:rounded-r-3xl"
      >
        ...
        <div className=" overflow-y-scroll scrollbar-hide my-14">
          <h1 className=" text-[#2a84e4] mb-4 font-medium">Bill From</h1>
          ...
          <h1 className=" text-[#2a84e4] my-4 mt-10 font-medium">Bill To</h1>
          ...
          <button
            ...
            className=" bg-gray-200  hover:opacity-80 mx-auto py-2 items-center dark:text-white dark:bg-[#273f64] justify-center rounded-xl  w-full mt-6"
          >
            + Add New Item
          </button>
        </div>
        ...
        <div className=" flex  justify-between">
          ...
          <div>
            <button
              className=" text-white  hover:opacity-80 mx-auto py-4 items-center bg-[#1E88E5] dark:bg-[#07439d] justify-center  px-8 rounded-full "
              onClick={() => {
