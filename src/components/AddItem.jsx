        ...
        <div className=" flex flex-wrap ">
          ...
          <div className=" flex px-2 py-2  flex-col items-start">
            ...
            <input
              ...
              min={0}
              className={` dark:bg-[#8c9296] py-2 px-4 border-[.2px] rounded-lg  focus:outline-purple-400 max-w-[60px] border-gray-300 focus:outline-none
          ...
          <div className=" flex px-2 py-2  flex-col items-start">
            ...
            <input
              ...
              min={0}
              className={` dark:bg-[#8c9296] py-2 max-w-[100px] px-4 border-[.2px] rounded-lg  focus:outline-purple-400 border-gray-300 focus:outline-none dark:border-gray-800`}
            />
          </div>

          <div className=" flex px-2 py-2  flex-col items-start">
            <h1>Total</h1>
            <div className=" max-w-[100px] dark:bg-[#8c9296] py-2 px-4 border-[.2px] rounded-lg focus:outline-none   focus:outline-purple-400 border-gray-300 dark:border-gray-800 dark:text-white">
              {itemDetails.total}
            </div>
          </div>
        </div>
